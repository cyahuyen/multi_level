...
class Faq extends MY_Controller {
    ...
    public function index() {
        $this->data['main_content'] = 'faq/index';
        $this->data['title'] = 'Multi Level Marketing';
        $this->view('admin/faq/index', 'admin');
    }

    public function questionlist($start = 0) {
...
//          Begin pagination
            ...
            $config["base_url"] = admin_url('faq/questionlist');
...
//       End pagination
            ...
            $json['questions'] = $this->load->view('admin/faq/questionlist', $this->data, true);
        }
    ...
    public function answer($id = 0) {
            ...
            if (count($validationErrors) != 0) {
                ...
                if (!$answer) {
                    ...
                    $dataUserMail = array(
                        ...
                        'link' => admin_url('faq/answer/' . $question->id)
                    );
                    ...
                    redirect(admin_url('faq/answer/'.$question->id));
                } else {
                    $dataAnswer = array(
                        'answer_content' => trim($posts['answer_content']),
                    );
        ...
        $this->View('admin/faq/answer', 'admin');
    }
