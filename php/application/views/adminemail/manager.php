    ...
    <div class="content-header">
        ...
        <div class="content-actions">
            <div class="content-action">
                <div class="clear"><a onclick="window.location = '<?php echo site_url('/adminemail/profile'); ?>'" href="javascript:void(0);"><img alt="Save Continue" src="<?php echo base_url(); ?>img/actions/add.png"></a></div>
