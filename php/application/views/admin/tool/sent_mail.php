<form action="" method="post">
    <div class="content-header">
        ...
        <div class="content-actions">
            ...
            <a class="button checkdirty" href="<?php echo admin_url('adminemail/manager') ?>">Cancel</a>
        </div>
    </div>
    <br><br>
    ...
    $(document).ready(function() {
        ...
        $("#user").autocomplete({
            ...
            source: function(request, response) {
                $.ajax({
                    url: "<?php echo admin_url('tool/user_ajax?term=') ?>" + request.term,
                    dataType: 'json',
            ...
            select: function(event, ui) {
                ...
                var html = '<div class="user_mng" id="user_' + ui.item.label+ '">';
                html += '<input type="hidden" name="user_list[]" value="'+ui.item.value+'">';
                html += '<span class="user_elm">'+ui.item.label+'</span>';
