<table id="userdata">
    ...
    <tbody>
        <?php foreach ($questions as $question) { ?>
            <tr class="row" id="row_<?php echo $question->id; ?>"> 
                <td ><div><?php echo $question->title; ?></div></td>
                <td ><div style="padding: 5px;"><?php echo utf8_substr(strip_tags($question->content), 0, 100) ?> ...</div></td>
                ...
                <td >
                    <a href="<?php echo admin_url('faq/answer/' . $question->id) ?>"><?php echo ($question->admin_status == 0) ? 'Answer' : 'View/Edit' ?></a>
                </td>
            </tr>
        <?php } ?>
    </tbody>
