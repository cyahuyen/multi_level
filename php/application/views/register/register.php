...
<table class="datatable">
    <tbody>
        <tr>
            ...
            <td>
                <input type="text" name"username" id="job-customer" value="" class="mandatory" style="width:480px"><img class="mandatory" src="../img/sev/required.jpg" title="This is a required value">
            </td>
        </tr>
        <tr>
            <td><div>UserName: </div></td>
            <td>
                <input type="text" id="job-customer" value="" class="mandatory" style="width:480px"><img class="mandatory" src="../img/sev/required.jpg" title="This is a required value">
            </td>
        </tr>
        <tr>
            <td><div>UserName: </div></td>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" id="job-startdate" value="" style="width:91px" class="hasDatepicker">
                <span style="padding:8px 8px">days</span>
                <input type="text" id="job-days" value="" style="width:40px">
                <script>$("#job-startdate").datepicker({dateFormat: "dd/mm/yy"});</script>
            </td>
        </tr>
    </tbody>
</table>
